...
@section('admincontent')
                    <div class="container-fluid px-4">
                        ...
                        <ol class="breadcrumb mb-4">
                            ...
                            <li class="breadcrumb-item"><a class="text-decoration-none" href="{{ route('maintenances.index') }}">Maintenance</a></li>
                            <li class="breadcrumb-item active">Maintenance Edit</li>
                        </ol>
                        @foreach ($maintenance as $item)
                            <div class="">
                                <form action="{{ route('maintenances.update', $item-> id_maintenance) }}" method="post" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                    <div class="row pb-3">
