...
<body>
                        ...
                        <div class="d-flex justify-content-center align-items-center">
                            ...
                            <div class="ms-4 d-flex align-items-center justify-content-center rounded-4 p-3 bg-danger w-100">
                                <div class="d-flex align-items-center justify-content-between col">
                                    ...
                                    <a class="mx-auto fw-bold" href="{{ route('theportofolios.index') }}" style="text-decoration: none; color: white;">The Portofolio</a>
        ...
        <div class="container">
            <div class="row d-flex justify-content-center align-items-center p-3">
                <div class="d-flex justify-content-center align-items-center p-3">
                    <h1 class="fw-bold text-center" style="color: #9E0000; font-size:4rem;">Portofolio</h1>
                </div>
            </div>
            <div class="container pb-5">
                <div class="responsive pb-3">
                    @foreach ($modal_portofolio1 as $modal_portofolios1)
                        <div data-bs-toggle="modal" data-bs-target="#exampleModal{{ $modal_portofolios1->id_modalportofolio }}" class="text-decoration-none">
                            <div class="card" style="width: 18rem; border-radius: 20px;">
                                <div class="card-img-top" style="height: 170px;">
                                    <img src="{{ asset('storage/'.$modal_portofolios1->picture) }}" class="h-100 w-100 object-fit-cover"  alt="Slide 1">
                                </div>
                                <div class="card-body">
                                    <h5 class="card-title text-start">{{ $modal_portofolios1->judul }}</h5>
                                </div>
                            </div>
                        </div>
                    @endforeach
                ...
                <div class="responsive pb-3">
                    @foreach ($modal_portofolio2 as $modal_portofolios2)
                        <div class="text-decoration-none" data-bs-toggle="modal" data-bs-target="#exampleModal{{ $modal_portofolios2->id_modalportofolio }}">
                            <div class="card" style="width: 18rem; border-radius: 20px;">
                                <div class="card-img-top" style="height: 170px;">
                                    <img src="{{ asset('storage/'.$modal_portofolios2->picture) }}" class="h-100 w-100 object-fit-cover"  alt="Slide 1">
                                </div>
                                <div class="card-body">
                                    <h5 class="card-title text-start">{{ $modal_portofolios2->judul }}</h5>
                                </div>
                            </div>
                        </div>
                    @endforeach
    ...
    @foreach ($modal_portofolio1 as $modal_portofolios1)
        <div class="modal fade" id="exampleModal{{ $modal_portofolios1->id_modalportofolio }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg">
                <div class="modal-content" style="border-radius: 34px;">
                    <div class="modal-body p-0" style="">
                        <div class="position-relative" style="height: 340px;">
                            <img style="width: 100%; height: 100%; object-fit: cover; border-top-left-radius: 30px;border-top-right-radius: 30px;"
                                src="{{ asset('storage/'.$modal_portofolios1->picture) }}" alt="">
                        </div>
                        <div class="position-absolute" style="top: 10px; right: 10px;">
                            <button aria-label="Close" data-bs-dismiss="modal"
                                class="border-0 d-flex justify-content-center align-items-center rounded-circle"
                                style="background-color: #CFFC03; width: 55px; height: 55px;">
                                <i class="fa fa-x fs-3"></i>
                            </button>
                        </div>
                    </div>
                    <div class="modal-body">
                        <h5 class="fw-bold lh-1 text-start">{{ $modal_portofolios1->judul }}</h5>
                        <p class="lh-1">
                            {{ $modal_portofolios1->isi }}
                        </p>
                    </div>
                </div>
            </div>
    ...
    @endforeach
    @foreach ($modal_portofolio2 as $modal_portofolios2)
        <div class="modal fade" id="exampleModal{{ $modal_portofolios2->id_modalportofolio }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg">
                <div class="modal-content" style="border-radius: 34px;">
                    <div class="modal-body p-0" style="">
                        <div class="position-relative" style="height: 340px;">
                            <img style="width: 100%; height: 100%; object-fit: cover; border-top-left-radius: 30px;border-top-right-radius: 30px;"
                                src="{{ asset('storage/'.$modal_portofolios2->picture) }}" alt="">
                        </div>
                        <div class="position-absolute" style="top: 10px; right: 10px;">
                            <button aria-label="Close" data-bs-dismiss="modal"
                                class="border-0 d-flex justify-content-center align-items-center rounded-circle"
                    ...
                    <div class="modal-body">
                        <h5 class="fw-bold lh-1 text-start">{{ $modal_portofolios2->judul }}</h5>
                        <p class="lh-1">
                            {{ $modal_portofolios2->isi }}
                        </p>
                    </div>
                </div>
            </div>
