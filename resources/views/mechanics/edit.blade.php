...
@section('admincontent')
                    <div class="container-fluid px-4">
                        ...
                        <ol class="breadcrumb mb-4">
                            ...
                            <li class="breadcrumb-item"><a class="text-decoration-none" href="{{ route('mechanics.index') }}">Mechanic</a></li>
                            <li class="breadcrumb-item active">Mechanic Edit</li>
                        </ol>
                        @foreach ($mechanic as $item)
                            <div class="">
                                <form action="{{ route('mechanics.update', $item-> id_mechanic) }}" method="post" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                    <div class="row pb-3">
