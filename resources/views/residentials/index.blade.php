...
<body>
                            ...
                            <div class="ms-4 d-flex align-items-center justify-content-center rounded-4 p-3 bg-danger w-100">
                                <div class="d-flex align-items-center justify-content-between col">
                                    ...
                                    <div class="dropdown mx-auto">
                                        <a class="dropdown-toggle fw-bold" href="#" role="button" id="ourServiceDropdown" data-bs-toggle="dropdown" aria-expanded="false" style="text-decoration: none; color: white;">
                                            Our Service
                                        </a>
    ...
    @foreach ($residental as $residentals)
        <section class="electric-page">
            <div class="container">
                <div class="row d-flex justify-content-center align-items-center p-3">
                    <div class="d-flex justify-content-center align-items-center p-3">
                        <h1 class="fw-bold text-center" style="color: #9E0000; font-size:4rem;">
                            Residential Home Construction</h1>
                    </div>
                </div>
