    ...
    <section class="cs-section">
                        ...
                        <div class="d-flex justify-content-center align-items-center">
                            ...
                            <div class="ms-4 d-flex align-items-center justify-content-center rounded-4 p-3 bg-danger w-100">
                                <div class="d-flex align-items-center justify-content-between col">
                                    ...
                                    <a class="mx-auto" href="{{ route('css.index') }}" style="text-decoration: none; color: white; font-weight:bold;">Contact Us</a>
                                    <div>
        ...
        <div id="menuhape" class="position-fixed top-0 w-65 h-100" style="z-index: 10; right: -75%; ">
            <div class="col-12 h-100 bg-danger d-flex flex-column" style="border-top-left-radius: 20px; border-bottom-left-radius: 20px;">
                ...
                <a class="dropdown-toggle ms-4" href="#" role="button" id="ourServiceDropdown" data-bs-toggle="dropdown" aria-expanded="false" style="text-decoration: none; color: white; font-weight: bold;">
                    <h4>Our Service</h4>
                </a>
                <ul class="dropdown-menu" aria-labelledby="ourServiceDropdown">
                    <li><a class="dropdown-item" href="{{ route('residentials.index') }}">Residential Home Construction</a></li>
                ...
                <a href="{{ route('css.index') }}" class="text-light my-2 text-decoration-none fw-bold ps-4"><h4>Contact Us</h4></a>
                @foreach ($contact as $contacts)
        ...
        <div class="container">
            <div class="row d-flex justify-content-center align-items-center p-3">
                <div class="d-flex justify-content-start align-items-center p-5">
                    <h1 class="text-center" style="font-size:2rem;">Lorem Ipsum is simply dummy text of the printing and typesetting industry</h1>
                </div>
            </div>
            @if(session('success'))
            ...
            <div class="contact-container">
                    <div class="form-section">
                        <form action="{{ route('konsultasis.store') }}" method="POST">
                        @csrf
                            <input type="text" name="name" class="form-control mb-3" placeholder="Nama">
                            <input type="email" name="email" class="form-control mb-3" placeholder="Email">
                            <input type="tel" name="no_telp" class="form-control mb-3" placeholder="No.Telp">
                            <textarea name="isi" class="form-control mb-3" rows="5" placeholder="Consultation"></textarea>
                            <button type="submit" class="btn btn-danger rounded w-100">Submit</button>
                        </form>
                    </div>
                <div class="map-section">
                    <iframe 
                        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3151.8354345091725!2d144.95373631531676!3d-37.8162793797517!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x6ad642af0f11fd81%3A0x5045675218ce6e0!2sMelbourne%20VIC%2C%20Australia!5e0!3m2!1sen!2sid!4v1601011634368!5m2!1sen!2sid" 
                        width="100%" 
                        height="100%" 
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="d-flex justify-content-end align-items-center pb-1 pt-3 pe-5">
                            <div class="" style="width: 100px; height: 100px;">
                                <img src="{{ asset('home/images/barcode.png')}}" style="object-fit: cover; width: 100%; height: 100%;" alt="">
                            </div>
                        </div>
