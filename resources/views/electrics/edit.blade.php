...
@section('admincontent')
                    <div class="container-fluid px-4">
                        ...
                        <ol class="breadcrumb mb-4">
                            ...
                            <li class="breadcrumb-item"><a class="text-decoration-none" href="{{ route('electrics.index') }}">Electric</a></li>
                            <li class="breadcrumb-item active">Electric Edit</li>
                        </ol>
                        @foreach ($electric as $item)
                            <div class="">
                                <form action="{{ route('electrics.update', $item-> id_electric) }}" method="post" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                    <div class="row pb-3">
