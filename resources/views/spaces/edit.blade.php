...
@section('admincontent')
                    <div class="container-fluid px-4">
                        ...
                        <ol class="breadcrumb mb-4">
                            ...
                            <li class="breadcrumb-item"><a class="text-decoration-none" href="{{ route('spaces.index') }}">Space</a></li>
                            <li class="breadcrumb-item active">Space Edit</li>
                        </ol>
                        @foreach ($space as $item)
                            <div class="">
                                <form action="{{ route('spaces.update', $item-> id_space) }}" method="post" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                    <div class="row pb-3">
