...
@section('admincontent')
                    ...
                    @endif
                                ...
                                <div class="row pb-3">
                                    <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        <div class="col-3 text-end">
                                            <a href="{{ route('spaces.edit',$item-> id_space) }}" type="button" class="btn btn-warning">
                        ...
                        @endforeach
                            ...
                            @foreach ($modal_space as $modal_spaces)
                                <div class="card mb-4">
                                    <div class="card-body">
                                        <table id="datatablesSimple">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>{{ $modal_spaces->id_modalspace }}</td>
                                                    <td>{{ $modal_spaces->judul }}</td>
                                                    <td>{{ $modal_spaces->isi }}</td>
                                                    <td>
                                                        <div class="d-flex justify-content-center align-items-center">
                                                            <div class="mb-2" style="width:150px; height:150px;">
                                                                <img class="w-100 h-100 object-fit-cover" src="{{  asset('storage/'.$modal_spaces->picture) }}" alt="">
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td class="text-center">
                                                        <div class="d-flex justify-content-center align-items-center">
                                                            <a type="button" data-bs-toggle="modal" data-bs-target="#EditModal{{ $modal_spaces->id_modalspace }}" class="btn btn-warning">
                                                                <small>Edit Data</small>
                                                            </a>
                                                            <form action="{{ route('modal_spaces.destroy', $modal_spaces->id_modalspace) }}" onsubmit="return confirm('Apakah Anda Ingin Menghapus Data Ini?')" method="POST">
                                                                {!! method_field('DELETE') !!}
                                                                {!! csrf_field() !!}
...
{{-- @foreach ($modal_space as $modal_spaces)
    <div class="modal fade" id="EditModal{{ $modal_spaces->id_modalspace }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-lg modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="exampleModalLabel">Edit Data Modal space</h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <form action="{{ route('modal_spaces.update', $modal_spaces->id_modalspace) }}" method="post" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="row py-3">
                        <div class="col-6">
                            ...
                            <div class="form-floating">
                                <textarea class="form-control" id="judul" name="judul">{{ $modal_spaces->judul }}</textarea>
                            </div>
                        </div>
                        <div class="col-6">
                            <label class="fw-bold mb-2" for="">Isi Modal</label>
                            <div class="form-floating">
                                <textarea class="form-control" id="isi" name="isi">{{ $modal_spaces->isi }}</textarea>
                            </div>
                        </div>
                    </div> 
                    <div class="row">
...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-lg modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="exampleModalLabel">Tambah Data Modal space</h1>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form action="{{ route('modal_spaces.store') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-6">
                            <label class="fw-bold mb-2" for="">Judul Modal </label>
