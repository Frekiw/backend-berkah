...
@section('admincontent')
                    <div class="container-fluid px-4">
                        ...
                        <ol class="breadcrumb mb-4">
                            ...
                            <li class="breadcrumb-item"><a class="text-decoration-none" href="{{ route('profils.index') }}">Profile</a></li>
                            <li class="breadcrumb-item active">Profile Edit</li>
                        </ol>
                        @foreach ($profile as $item)
                            <div class="">
                                <form action="{{ route('profils.update', $item-> id_profile) }}" method="post" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                    <div class="row pb-3">
