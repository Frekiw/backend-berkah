...
<body>
                        ...
                        <div class="d-flex justify-content-center align-items-center">
                            ...
                            <div class="ms-4 d-flex align-items-center justify-content-center rounded-4 p-3 bg-danger w-100">
                                <div class="d-flex align-items-center justify-content-between col">
                                    <a class="mx-auto" href="{{route('theprofiles.index')}}" style="text-decoration: none; color: white;">Profile</a>
    ...
    <section id="our-service" class="isi-index-page">
        <div class="row">
            <div class="container">
                <div class="d-flex justify-content-center align-items-center">
                    <div class="col-4">
                        <p class="tek2 mx-5 my-5 fw-bold" style="font-size: 2.5rem; color: #4f4f4f;">In good company</p>
                    </div>
                    <div class="col-8">
                        <p class=" tek1 fs-6 mx-5 my-5 fw-semibold">{{ $homepages->text1 }}</p>
                    </div>
                </div>
            </div>
            <div class="d-flex justify-content-end align-items-center">
                <div class="text-end px-5">
                    <a href="{{route('theprofiles.index')}}" class="btn btn-danger fw-semibold d-flex justify-content-center align-items-center" style="width: 100%; height:100%; border-radius: 15px;">
                        Read More
                    </a>
                </div>
            </div>
        ...
        <div class="position-relative">
            <div class="api" style="width:  700px;">
                <img src="{{ asset('home/images/Clip path group.png') }}" class="w-100 h-100 object-fit-cover" style="margin-top: 150px;" alt="">
            </div>
            <div class="bungklus position-absolute bottom-0">
                <div class="row">
                    <div class="container">
                        <div class="">
                            <div class="row">
                                <div class="d-flex justify-content-center align-items-center kelas1">
                                    <div class="col-md-3">
                                        <a href="home/residental.html" class="bulet rounded-circle bg-danger mx-auto my-4 d-flex align-items-center justify-content-center">
                                            <img src="{{ asset('home/images/Isolation_Mode.png') }}" class="iken" alt="">
                                        </a>
                                    </div>
                                    <div class="col-md-8">
                                        <p class="fw-bold my-auto mx-5 lh-1" style="color: #9E0000; font-size: 3rem;">Residential
                                            Home
                                            Construction</p>
                                        <p class="text-start fs-6 mx-5 lh-1">{{ $homepages->text2 }}
                                        </p>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="d-flex justify-content-center align-items-center kelas2">
                                    <div class="col-md-3">
                                        <a href="home/mechanical.html" class="bulet rounded-circle bg-danger mx-auto my-4 d-flex align-items-center justify-content-center">
                                            <img src="{{ asset('home/images/Isolation_Mode (1).png') }}" class="iken" alt="">
                                        </a>
                                    </div>
                                    <div class="col-md-8">
                                        <p class="fw-bold my-auto mx-5 lh-1" style="color: #4F4F4F; font-size: 3rem;">Mechanical Installation</p>
                                        <p class="text-start fs-6 mx-5 lh-1">{{ $homepages->text3 }}
                                        </p>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="d-flex justify-content-center align-items-center kelas3">
                                    <div class="col-md-3">
                                        <a href="home/space.html" class="bulet rounded-circle bg-danger mx-auto my-4 d-flex align-items-center justify-content-center">
                                            <img src="{{ asset('home/images/Isolation_Mode (2).png') }}" class="iken" alt="">
                                        </a>
                                    </div>
                                    <div class="col-md-8">
                                        <p class="fw-bold my-auto mx-5 lh-1" style="color: #4F4F4F; font-size: 3rem;">Space Planning</p>
                                        <p class="text-start fs-6 mx-5 lh-1">{{ $homepages->text4 }}
                                        </p>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="d-flex justify-content-center align-items-center kelas4">
                                    <div class="col-md-3">
                                        <a href="home/maintenance.html" class="bulet rounded-circle bg-danger mx-auto my-4 d-flex align-items-center justify-content-center">
                                            <img src="{{ asset('home/images/Isolation_Mode (3).png') }}" class="iken" alt="">
                                        </a>
                                    </div>
                                    <div class="col-md-8">
                                        <p class="fw-bold my-auto mx-5 lh-1" style="color: #4F4F4F; font-size: 3rem;">Maintenance and Repair</p>
                                        <p class="text-start fs-6 mx-5 lh-1">{{ $homepages->text5 }}
                                        </p>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="d-flex justify-content-center align-items-center kelas5">
                                    <div class="col-md-3">
                                        <a href="home/electric.html" class="bulet rounded-circle bg-danger mx-auto my-4 d-flex align-items-center justify-content-center">
                                            <img src="{{ asset('home/images/Isolation_Mode (4).png') }}" class="iken" alt="">
                                        </a>
                                    </div>
                                    <div class="col-md-8">
                                        <p class="fw-bold my-auto mx-5 lh-1" style="color: #4F4F4F; font-size: 3rem;">Electrical Installations for Residential
                                            Homes and Buildings</p>
                                        <p class="text-start fs-6 mx-5 lh-1">{{ $homepages->text6 }}
                                        </p>
                                    </div>
                                </div>
                            </div>
    ...
    <section class="isi1-page position-relative">
        <div class="">
            <p class="mx-5 fw-bold" style="font-size: 80px; color: #4f4f4f;">The Portofolio</p>
        </div>
        <div class="container my-5">
            <div class="responsive">
                @foreach ($modal_portofolio as $modal_portofolios)
                    <a href="{{ route('theportofolios.index') }}" class="text-decoration-none">
                        <div class="card" style="width: 18rem; border-radius: 20px;">
                            <div class="card-img-top" style="height: 170px;">
                                <img src="{{  asset('storage/'.$modal_portofolios->picture) }}" class="w-100 h-100 object-fit-cover" alt="Slide 1">
                            </div>
                            <div class="card-body">
        ...
        <div class="my-5">
            <p class="mx-5 fw-bold" style="font-size: 80px; color: #4f4f4f;">News & Article</p>
        </div>
            <div class="d-flex justify-content-center align-items-center">
                @foreach ($modal_article as $modal_articles)
                    <div class="card2 mx-2 col-md-3" style="width: 20rem; border-radius: 20px;">
                        <div class="card-img-top" style="height:270px;">
                            <img src="{{  asset('storage/'.$modal_articles->picture) }}" class=" w-100 h-100 object-fit-cover" alt="...">
                        </div>
                        <div class="card-body">
                            <h6 class="card-title">{{ $modal_articles->judul }}</h6>
                            <p class="card-text fs-6 elipsis" >{{ $modal_articles->isi }}
                            </p>
                            <div class="text-end">
    ...
    <div class="12" style="background-color:#E9E9E9;">
                ...
                <div class="container">
                    <div class="d-flex">
                        <div class="col-md-6">
                            ...
                            <div class="py-5">
                                <a href="#"
                                    style="text-decoration: none; color: white; font-weight: 700; font-size: 2rem;">FAQs</a>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="d-flex justify-content-end align-items-center p-3 pt-4 me-3">
                                <div class="rounded-circle d-flex justify-content-center align-items-center logofoot">
                                    <div class="d-flex justify-content-center align-items-center"
                                        style="width: 101px; height: 76px; margin-bottom: 15px;">
                                            <img style="width: 100%; height: 100%; object-fit: cover;" src="{{ asset('home/images/logo.png') }}"
                                                alt="">
                                    </div>
                                </div>
                            </div>
                            <div class="d-flex justify-content-end align-items-center">
                                <small class="text-white text-end">Lorem Ipsum is simply dummy text of<br> the printing and
                                    typesetting industry.<br> Lorem Ipsum has been the industry's<br> standard dummy text
                                    ever since the<br> 1500s, when an unknown printer took a<br> galley of type and
                                    scrambled it to make<br> a type specimen book. </small>
                            </div>
                            <div class="d-flex justify-content-end align-items-center pb-1 pt-3 pe-5">
                                <div class="" style="width: 100px; height: 100px;">
                                    @foreach ($contact as $contacts)
                                        <img src="{{ asset('storage/'.$contacts->qr_code) }}" style="object-fit: cover; width: 100%; height: 100%;"
                                            alt="">
                                    @endforeach
                                </div>
                            </div>
                            ...
                            <div class="d-flex justify-content-end align-items-center  pt-3">
                                <small class="text-white text-center fw-bold fs-6">© Copyright BSG. All Rights
                                    Reserved</small>
                            </div>
                        </div>
                    </div>
    ...
    <script src="https://code.jquery.com/jquery-3.6.0.min.js"
        integrity="sha384-KyZXEAg3QhqLMpG8r+Knujsl5+5hb7ue2lV2jn5+7GRJ5R4SO2m9m6y1wf4ZXeyPv" crossorigin="anonymous">
    </script>
    <!-- Popper.js -->
    <script src="https://cdn.jsdelivr.net/npm/@popperjs/core@2.11.8/dist/umd/popper.min.js"></script>
    <!-- Bootstrap Bundle JS (without Popper included separately) -->
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/js/bootstrap.min.js"></script>
    <script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>
    <!-- Link ke JavaScript Slick Slider -->
